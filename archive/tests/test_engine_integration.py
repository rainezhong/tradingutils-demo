...
class TestRiskIntegration:
    ...
    def test_position_synced_to_risk_manager(self, engine: MarketMakingEngine) -> None:
...
class TestSimulationIntegration:
    ...
    def test_multi_market_with_scenarios(self, mock_api_client: MockAPIClient) -> None:
...
class TestErrorHandling:
    ...
    def test_engine_handles_errors_gracefully(self, engine: MarketMakingEngine) -> None:
    ...
    def test_multi_engine_unknown_ticker(self, mock_api_client: MockAPIClient) -> None:
