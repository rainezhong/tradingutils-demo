...
class ArbitrageOrchestrator:
    ...
    def set_on_opportunity(
        self, callback: Callable[[RankedOpportunity], None]
    ) -> None:
                ...
                if opportunities:
                    ...
                    if not self._state.paused:
                        for opp in opportunities:
                            ...
                            if len(self._active_spreads) >= self._config.max_concurrent_spreads:
                                logger.debug(
    ...
    async def _scan_opportunities(self) -> List[RankedOpportunity]:
        ...
        opportunities = await loop.run_in_executor(
            None, self._detector.scan_all_pairs
        )
    ...
    def get_status(self) -> Dict:
        ...
        return {
            ...
            "detector_stats": (
                self._detector.get_stats() if self._detector else None
            ),
        }
