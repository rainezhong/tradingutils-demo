...
async def create_orchestrator(
    ...
    try:
        ...
        try:
            ...
            LiveQuoteMarketMatcher = None  # type: ignore
        ...
        try:
            ...
            SpreadExecutor = None  # type: ignore
            CapitalManager = None  # type: ignore
            OrderManagementSystem = None  # type: ignore
        ...
        try:
            ...
            AlertConfig = None  # type: ignore

        if KalshiExchange is None or PolymarketExchange is None:
            raise ImportError("Exchange clients not available")
        ...
        # Quote provider
        if LiveQuoteMarketMatcher is not None:
        ...
        if AlertManager is not None and AlertConfig is not None:
            try:
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Kalshi/Polymarket Arbitrage System")
    parser.add_argument(
        "--config",
        "-c",
